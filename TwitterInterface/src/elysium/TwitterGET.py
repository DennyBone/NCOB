...
CONSUMER_KEY = 'Vpr0MN1NjjLDySLVIF6Ek0cwp'
# CONSUMER_KEY = os.getenv("CONSUMER_KEY", None)
CONSUMER_SECRET = 'JIxPaK8fDqpwiSRIlVUe9hq2b5fHbSHvmMIrwdgtxZancOzXnB'
# CONSUMER_SECRET = os.getenv("CONSUMER_SECRET", None)
ACCESS_TOKEN = '830912238013861891-JT4ZUUkHYYPUkhnksr86IxayGPLL9Sz'
# ACCESS_TOKEN = os.getenv("ACCESS_TOKEN", None)
ACCESS_TOKEN_SECRET = 'NNFRpHEzfOgSaRhyBkCAOP2Q5rc3yEuk1uChqbNFbwJtr'
...
# about rate limits.
restApi = twitter.Api(CONSUMER_KEY,
          CONSUMER_SECRET,
          ACCESS_TOKEN,
          ACCESS_TOKEN_SECRET)
...
def main():
    with open('C:/Dennis/output.txt', 'a') as f:
        # api.GetStreamFilter will return a generator that yields one status
        # message (i.e., Tweet) at a time as a JSON dictionary.
        for line in restApi.GetStreamFilter(track=USERS, languages=LANGUAGES):
